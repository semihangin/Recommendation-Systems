...
Transaction formatına dönüştürme

Apriori ile sık öğe kümelerini çıkarma
...
İş problemine uygun öneriler çıkartılabilir (örn. çapraz satış stratejileri)
...
Kullanıcı benzerlikleri hesaplama

İçerik benzerlikleri üzerinden öneriler üretme
...
Sistem performansının klasik yöntemlere göre artması

🧩 Genel Değerlendirme

Her iki çalışma da veri bilimi projelerinde temel teknikleri aktaran uygulama örnekleri sunmaktadır. Birliktelik kuralları analizi, ürün ilişkilendirme alanlarında önemliyken; hibrit öneri sistemleri modern dijital platformlarda kişiselleştirilmiş deneyim sağlamada kritik öneme sahiptir.
